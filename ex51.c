...
char getch();
 ...
 /***********************************************************************
*Function Name:error_sys_call
*Function input:none
*Function output:none
*Function Action:the function print error system call
***********************************************************************/
void error_sys_call()
{
    //call system - error
...
char getch()
{
 ...
 /***********************************************************************
*Function Name:isCharValid
*Function input:user input keyboard
*Function output:1 - if input is valid, else 0
*Function Action:the function check if the user input is valid direction
***********************************************************************/
